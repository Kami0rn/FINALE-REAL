...
const Index: React.FC = () => {
    return (
        <div className="relative min-h-screen bg-cover bg-center" 
            ...
            {/* Make sure opacity is not too strong */}
            <div className="absolute inset-0 bg-black bg-opacity-20 backdrop-blur-none"></div>

            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
                
                {/* Header */}
                <header className="w-full py-4 animate-gradient">
                ...
                {/* Main Section */}
                <main className="flex flex-col items-center justify-center flex-1 px-4 animate-fadeIn">
                ...
                {/* Footer */}
                <footer className="w-full py-4 text-center text-white animate-gradient">
